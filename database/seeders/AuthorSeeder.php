    ...
    public function run(): void
    {
        $authors = [
            [
                ...
                'description' => 'Fue un astrónomo, astrofísico, cosmólogo, astrobiólogo, escritor y principalmente un reconocido divulgador científico estadounidense. Inicialmente fue profesor asociado de la Universidad de Harvard y posteriormente profesor principal de la Universidad de Cornell.'
            ],
            [
                'name' => 'Jorge Bucay',
            ...
            [
                ...
                'description' => 'Joanne Rowling, quien escribe bajo los seudónimos de J. K. Rowlingy Robert Galbraith, es una escritora, productora de cine y guionista británica, conocida por ser la autora de la serie de libros Harry Potter, que han superado los quinientos millones de ejemplares vendidos.​'
            ],
            [
                'name' => 'Ana Frank',
                'nationality' => 'Alemana',
                'description' => 'Annelies Marie Frank, conocida en español como Ana Frank, fue una niña alemana de ascendencia judía, mundialmente conocida gracias al Diario de Ana Frank, la edición de su diario íntimo en donde dejó constancia de los casi dos años y medio que pasó ocultándose de los nazis en Ámsterdam, con su familia y cuatro personas más, durante la Segunda Guerra Mundial.'
            ],
        ];
